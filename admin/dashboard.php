    ...
    <div class="container">
        <div class="navigation">
            <ul>
                <li>
                    <a href="#">
                        <img style="width: 80px; margin-top: 0.5rem;" src="../images/cup-cafe-removebg" alt="Cafe Shop">
            ...
            <section class="dashboard">
                ...
                <div class="cardBox">
                    ...
                    <div class="card">
                        ...
                        ?>
                        <div>
                            <div class="numbers"><span>$</span><?= $total_pendings; ?></div>
                    ...
                    <div class="card">
                        ...
                        ?>
                        <div>
                            <div class="numbers"><span>$</span><?= $total_completes; ?></div>
                    ...
                    <div class="card">
                        ...
                        ?>
                        <div>
                            <div class="numbers"><span>$</span><?= $total_completes + $total_pendings; ?></div>
